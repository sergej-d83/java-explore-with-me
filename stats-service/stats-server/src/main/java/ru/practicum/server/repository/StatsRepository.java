...
//    List<ViewStatsDtoOriginal> getStatsByUrisAndIp(LocalDateTime start, LocalDateTime end, List<String> uris);
//
...
//            "order by hits desc", nativeQuery = true)
//    List<ViewStatsDtoOriginal> getStatsByUris(LocalDateTime start, LocalDateTime end, List<String> uris);
//
...
//            "group by h.uri, h.app " +
//            "order by hits desc", nativeQuery = true)
//    List<ViewStatsDtoOriginal> getStatsByTime(LocalDateTime start, LocalDateTime end, Boolean unique);
